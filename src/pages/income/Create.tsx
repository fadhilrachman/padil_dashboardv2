        ...
        <div className="border mt-7  border-[#55597D] border-opacity-30 p-5 rounded-lg">
          <div className="sm:text-right   w-[700px]">
            ...
            <BaseInput
              ...
              isInvalid={!!formik.errors.total_pemasukan}
          ...
          <div className="sm:text-right   w-[700px] mt-5">
            ...
            <BaseInput
              ...
              isInvalid={!!formik.errors.tanggal}
          ...
          <div className="sm:text-right   w-[700px] mt-5">
            ...
            <BaseSelect
              ...
              isInvalid={!!formik.errors.kategori}
          ...
          <div className="sm:text-right   w-[700px] mt-5 flex items-start justify-end">
            <label htmlFor="" className="mr-4">
              Description
            </label>
            <TextArea
